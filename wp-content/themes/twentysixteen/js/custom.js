...
(function($) {
  $(document).ready(function() {
    ...
    var $accor = jQuery('.accordion');

    $accor.each(function() {
      jQuery(this).addClass('ui-accordion ui-widget ui-helper-reset');
      ...
      jQuery(this).find("h3").first().removeClass('ui-accordion-header-active ui-state-active ui-corner-top').addClass('ui-accordion-header-active ui-state-active ui-corner-top');
      jQuery(this).find("span").first().addClass('ui-accordion-icon-active');
    });
